const testimonialsContainer = document.querySelector<HTMLDivElement>(
  '.testimonials-container'
)
const testimonial = document.querySelector<HTMLParagraphElement>('.testimonial')
...
const role = document.querySelector<HTMLParagraphElement>('.role')
